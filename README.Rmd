...
```{r robis, warning=FALSE, collapse=FALSE, message=FALSE, eval=FALSE}
...
```{r do call, warning=FALSE, collapse=FALSE, message=FALSE, eval=FALSE}
# SELECT COLUMN 
...
```{r spatialPlot1, out.width="100%", warning=FALSE}
...
```{r spatialPlot2, out.width="100%", warning=FALSE}
plot( st_geometry(world), col = "grey90", border = "grey10")
...
```{r dtm, out.width="100%", message=FALSE, warning=FALSE}
library(terra)
...
```{r dtm1500, out.width="100%", message=FALSE}
library(terra)
dtm <- dtm
...
```{r spatialPlot3, out.width="100%", dpi=600}
